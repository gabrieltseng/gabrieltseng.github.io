...
[Link to code](https://github.com/GabrielTseng/LearningDataScience/blob/master/Natural_Language_Processing/TwitterDisasters/1-Tweets%20from%20IDs.ipynb)
...
{% endraw %}
(These are described in more detail in my [jupyter notebook](https://github.com/GabrielTseng/LearningDataScience/blob/master/Natural_Language_Processing/TwitterDisasters/2%20-%20COWTS.ipynb))
...
If I was to do this project again, I would use a **[witter specific](http://www.nltk.org/howto/twitter.html) tokenizer**. 
